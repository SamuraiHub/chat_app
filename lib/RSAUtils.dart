...
class RSAUtils {
  ...
  static late RSAPrivateKey privateKey;

  static late RSAUtils instance;
  ...
  RSAUtils(String publicKeyFile, String privateKeyFile) {
    if (publicKeyFile != null) {
      publicKey = parse(publicKeyFile) as RSAPublicKey;
    }
    if (privateKeyFile != null) {
      privateKey = parse(privateKeyFile) as RSAPrivateKey;
    }
  }
  ...
  ///RSA public key encryption with public key as input
  Uint8List encryptWithPublicKey(Uint8List data, RSAPublicKey PublicKey) {
    try {
      var keyParameter = () => PublicKeyParameter<RSAPublicKey>(PublicKey);
      AsymmetricBlockCipher cipher = AsymmetricBlockCipher("RSA/PKCS1");
      cipher.reset();
  ...
  RSAAsymmetricKey parse(String key) {
    ...
    return throw ('Wrong File Header');
  }
